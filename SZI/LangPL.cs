...
namespace SZI
{
    ...
    static class LangPL
    {
        ...
        static public Dictionary<string, string> FaqAnswers = new Dictionary<string, string>()
        {
            ...
            {"dataBaseComboBox", "Pola niektórych tabel są zasilane danymi z innych tabel. Zawartość tych pól jest wybierana przez użytkownika za pomocą rozwijanych list, które zawierają wszystkie rekordy z obcej tabeli. "},
            {"dataBaseComboBoxUse", "Aby móc przeglądać zawartość rozwijanej listy należy ją rozwinąć poprzez kliknięcie. Po zdecydowaniu, który rekord jest właściwy w danym przypadku, należy go kliknąć, aby został wybrany. Lista zostanie zwinięta i zacznie wyświetlać skrócone informacje o wybranym rekordzie. \r\n W niektórych przypadkach wskazane jest wybranie pustego rekordu, jest on umieszczony na pierwszym miejscu w rozwijanych listach. \r\n Jeśli chcemy wycofać się z możliwości wyboru rekordu rozwijanej listy, należy kliknąć miejsce poza nią. "},
            {"dataBaseComboBoxFindItem", "Niektóre rozwijane listy mogą zawierać dużą ilość rekordów, co utrudnia dokonanie wyboru. Kiedy lista jest rozwinięta, możemy filtrować jej zawartość. Wystarczy zacząć pisać poszukiwany tekst. \r\n Jeśli chcemy usunąć ostatni element filtra, należy nacisnąć klawisz Backspace. \r\n Filtr jest nieczuły na wielkość liter i polskie znaki. \r\n Z listy przefiltrowanej rekordy wybiera się w ten sam sposób co ze zwykłej listy. "},
